			...
			<div class="blogkit-featured-post">
				...
				<div class="blogkit-featured-overlay">
					...
					<div class="blogkit-featured-meta">
						<span class="author"><?php echo get_avatar(get_the_author_meta('ID'));
						echo get_the_author_meta('display_name', $featured_post->post_author); ?></span>
						<span class="date"><?php echo svg::Calender();
						echo get_the_date('F j, Y', $featured_post->ID); ?></span>
						<span class="comments"><?php echo svg::Comments();
						echo get_comments_number($featured_post->ID); ?>
							Comments</span>
					</div>
				</div>
			</div>
				...
				<div class="blogkit-card-grid-item">
					<a href="<?php echo get_permalink($post->ID); ?>">
						...
						<div class="blogkit-overlay-content">
							...
							<<?php echo $title_tag; ?>
								class="blogkit-card-grid-title"><?php echo esc_html(get_the_title($post->ID)); ?></<?php echo $title_tag; ?>>
						</div>
					</a>
				</div>
				<?php
